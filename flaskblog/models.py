...
class Post(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'),
                        nullable=False)
    post_history = db.relationship('PostHistory', backref='post',
                                   lazy=True)
...
class DeletedPost(db.Model):
    ...
    date_posted = db.Column(db.DateTime, nullable=False)
    date_edited = db.Column(db.DateTime, nullable=False)
    date_deleted = db.Column(db.DateTime, nullable=False,
                             default=datetime.utcnow)
    content = db.Column(db.Text, nullable=False)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'),
                        nullable=False)
...
class DeletedPostHistory(db.Model):
    ...
    date_edited = db.Column(db.DateTime, nullable=False)
    content = db.Column(db.Text, nullable=False)
    post_id = db.Column(db.Integer, db.ForeignKey('deleted_post.id'),
                        nullable=False)
